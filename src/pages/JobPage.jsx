          ...
          <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
            <main>
              <div className="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
                ...
                <div className="text-gray-500 mb-4 flex align-middle justify-center md:justify-start">
                  <FaMapMarker className='text-organge-700 mr-1'/>
            ...
            <aside>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="my-2 bg-teal-100 p-2 font-bold">{job.company.contactPhone}</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                ...
                <Link
                  to={`/edit-job/${job.id}`}
                  className="bg-teal-700 hover:bg-teal-900 text-white text-center font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block"
                >
                  Edit Job
                </Link>
